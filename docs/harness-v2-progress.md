...
## Active follow-up: appearance and first use
...
- [Appearance and onboarding research](harness-v2-appearance-onboarding.md) records primary-source observations and product decisions. Onboarding is next: reduce first-workspace choices, make the product's value clear, offer an existing agent directly or a clear first-agent action, then explain grouping in context. Use isolated state rather than signing out the user's real account.
