...
Updated 2026-09-13 with Models, combined closed-work History and faster unified search. This is a working preview, not a release.
...
- [The revised keyboard plan](harness-v2-keyboard-system.md) and [prototype evidence](harness-v2-prototype-review.md) are current. Manual splits/resizing, optional lightweight search preview and commands in search are now explicitly approved; editor/diff handoff, structured output navigation and automation API are parked. The user is still actively reviewing product decisions; do not assume they are asleep.
