...
Updated 2026-09-13 after replacing the search launcher with an editable title-bar input and attached results. This is a working preview, not a release.

## Current continuation: editable title-bar search and keyboard configuration
