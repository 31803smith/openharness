...
export function mount(stage,api){
  ...
  return {update(params,r,motion){p=params;result=r;screen.motion(motion);if(r?.data?.frames&&r.id!==last){last=r.id;start=now;index=0;scrub.max=r.data.frames.length-1;}}};
}
