...
void main() {
  ...
  for (final scale in [1.0, 2.0]) {
    testWidgets('Layout choices fit the minimum window at text scale $scale', (
      tester,
    ) async {
      ...
      if (output != null) {
        ...
        await tester.runAsync(() async {
          ...
          await File('$output/layout-880-$scale.png')
              .writeAsBytes(bytes!.buffer.asUint8List());
          image.dispose();
        });
      }
      expect(tester.takeException(), isNull);
      final choices = PanePreset.forCount(5);
      ...
      final below = choices.firstWhere((preset) {
