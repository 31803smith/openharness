...
class _VoiceMicButtonState extends State<VoiceMicButton>
  ...
  Widget build(BuildContext context) {
    ...
    final transcribing = status == VoiceInputStatus.transcribing;
    return Semantics(
      button: true,
      label: transcribing
          ? 'Transcribing'
          ...
          child: Stack(
            ...
            children: [
              ...
              AnimatedContainer(
                ...
                // The words are with the backend: nothing to start or stop
                // until they are back, and the button says it is busy.
                child: transcribing
                    ? Center(
                        child: SizedBox.square(
                          dimension: 22,
