...
/// The language voice input is transcribed in, as a two-letter chip.
class VoiceLanguageChip extends StatelessWidget {
  const VoiceLanguageChip({
    super.key,
    required this.label,
    required this.onTap,
  });
  ...
  Widget build(BuildContext context) => Semantics(
    ...
    child: GestureDetector(
      key: const ValueKey('voice-language'),
      onTap: onTap,
      child: Container(
