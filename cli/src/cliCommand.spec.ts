...
describe('CLI login/start command contract', () => {
  ...
  // The wait above is 20s by design — a dev-mode start transpiles cli.ts and its imports cold, and under
  // the suite's four workers that alone can pass vitest's 5s default. The case's budget is its wait's.
  }, 25_000)
